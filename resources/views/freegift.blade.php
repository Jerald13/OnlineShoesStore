...
<section>
    <div class="container my-5">
        ...
        @else
        <header class="mb-4">
            <h3>Free Gift Redemption</h3>
            <p>Your Pointm : {{auth()->user()->getAttribute('point')}}</p>
        </header>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="card w-100 my-2 shadow-2-strong">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text">Redemption point:  {{$gift['point']}}</p>
                            <p class="card-text">Quantity : {{$gift['quantity']}}</p>
                            <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                <a href="{{route('redeem', [$gift['point'], $gift['id']])}}" class="btn btn-primary shadow-0 me-1">Redeem</a>
                            </div>
                        </div>
                    </div>
                </div>
